...
namespace a.Controllers
{
    ...
    public class PurchaseController: ControllerBase
    {
        ...
        //[ProducesResponseType(typeof(PurchaseDto), StatusCodes.Status200OK)]
        //[ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<ActionResult<IEnumerable<PurchaseDto>>> GetCartByUserId(int id)
        {
            var cart = await _orderService.GetAllPurchasesIsDraftAsync(id);
        ...
        public async Task<ActionResult<IEnumerable<PurchaseDto>>> GetByPresentId(int presentId)
        {
            var orders = await _orderService.GetByPresentIdAsync(presentId);
            return Ok(orders);
        }
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public async Task<ActionResult<PurchaseDto>> UpdateAsync(int id, [FromBody] UpdatePurchaseDto updateDto)
        {
            try
            {
